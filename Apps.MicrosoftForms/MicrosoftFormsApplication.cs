using Apps.MicrosoftForms.Auth.OAuth2;
...
public class MicrosoftFormsApplication : BaseInvocable, IApplication, ICategoryProvider
{
    ...
    public MicrosoftFormsApplication(InvocationContext invocationContext) : base(invocationContext)
    {
